...
bot_username = 'Emirhan_MusicBot'
support = 'WolfTeamChatl'
owner = 'SakirBey2'
bot_name = '𝙒𝙊𝙇𝙁║𝐄𝐌𝐈̇𝐑𝐇𝐀𝐍 𝐓𝐀𝐆𝐆𝐄𝐑'
api_id = '21899683'
api_hash = '24eb86b3831dd9bf3543796538a8256c'
bot_token = '7728779851:AAFW5kbNswMOycUofU3sqETsvoFGh8QuNfM'

SUDO_USERS = '5710250764'

client = TelegramClient('client', api_id, api_hash).start(bot_token=bot_token)

anlik_calisan = []

log_grub = -1002262163255
